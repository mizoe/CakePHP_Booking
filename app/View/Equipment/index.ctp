<div class="equipment index">
	...
	<tr>
		...
		<td><?php echo h($equipment['Equipment']['is_deleted']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $equipment['Equipment']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $equipment['Equipment']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
